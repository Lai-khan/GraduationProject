...
const MSG_NICKNAME_EMPTY = "별명을 입력해주세요.";
const MSG_NICKNAME_SHORT = "별명의 길이가 " + idLength + "자 이상인지 확인해주세요.";
const MSG_NICKNAME_FORMAT = "별명의 특수 문자를 확인해주세요. 특수 문자는 -, _만이 가능합니다.";
...
const MSG_STRING_EMPTY = "별명/이메일이 비어있습니다.";
const MSG_STRING_FORMAT = "별명/이메일의 형식이 맞지 않습니다.";
